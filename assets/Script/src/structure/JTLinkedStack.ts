module com 
{
    export class JTLinkedStack<V> extends JTCollection<V>
    {
        protected _linkedList:JTSLinkedList<V> = null;
        constructor(linkedList?:JTSLinkedList<V>)
        {
            super()
            this._linkedList = linkedList;
            if (!this._linkedList)
            this._linkedList = new JTSLinkedList();
        }
