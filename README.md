...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Rabbit-IOC 是一个跨引擎的前端框架(注入、注解、Mapping映射、控制反转、帧（追帧、帧同步、优化帧、帧均摊）计时器（计时器、均摊、循环计时器)、携程、线程、对象池、WebsocketChannel、HttpChannel、Template、计数器、引用计数、pomise\yeild等技术封装)可以让前端的开发大幅度提高
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
框架启动配置
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
